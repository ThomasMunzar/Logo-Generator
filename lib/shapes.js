...
class Square extends Shapes{
    ...
    render(){
        return `<rect x="10" y="10" width="150" height="150" fill="${this.fillColor}"/><text x="90" y="110" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text>` //Will render the specific shape will use rectangle
    }
}
